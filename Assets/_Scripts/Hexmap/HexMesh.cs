...
namespace _Scripts.Hexmap
{
	...
	{
		[SerializeField] private bool useCollider, useCellData, useUVCoordinates, useUV2Coordinates;

		[NonSerialized] private List<Vector3> vertices, cellIndices;
		[NonSerialized] private List<Color> cellWeights;
		[NonSerialized] private List<Vector2> uvs, myUV2S;
